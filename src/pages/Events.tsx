...
const events = [
  {
    ...
    description:
      "A 54-hour event where participants collaborate, build startup ideas, and receive guidance from mentors and industry experts.",
    registerLink: "#"
  },
  {
    id: 2,
    ...
    category: "Talk",
    image: "/events/founders-talk.jpg",
    description:
      "An interactive session with successful founders sharing their journey of fundraising, scaling, and building sustainable startups.",
    registerLink: "#"
  },
  {
    id: 3,
    ...
    image: "/events/pitch-perfect.jpg",
    description:
      "E-Cell RVU’s flagship pitching competition where aspiring entrepreneurs present their ideas to judges and compete for exciting prizes.",
    registerLink: "#"
  }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-6xl md:text-8xl font-bold tracking-tighter uppercase mb-6">
            Upcoming{" "}
            <WordRotator
              words={['Events', 'Workshops', 'Meetups']}
              className="text-indigo-600 dark:text-indigo-400"
            />
          </h1>
          <p className="text-xl text-black/60 dark:text-white/60 max-w-2xl font-medium">
            Join our workshops, talks, and competitions to learn, connect, and grow in your entrepreneurial journey.
          </p>
        </motion.div>
            ...
            >
              ...
              <div className="p-10 lg:p-16 flex flex-col justify-center">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-3 text-sm font-bold uppercase tracking-[0.2em] group/btn"
                >
                  Register Now
